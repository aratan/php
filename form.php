    ...
    <main class="container-fluid">
        <div class="row caja-form">
            <section class="col-12 col-md-6 col-sm-12">
                <form id="form-post" name="envia-post_frm" action="post.php" method="post" enctype="application/x-www-form-urlencoded">
                    <h3>Usuario</h3>
                    <input class="entrada form-control" type="text" name="nombre_txt" id="input-post" placeholder="correo">
                    <input class="entrada form-control" type="password" name="password_txt" id="input-post" placeholder="contraseña">
